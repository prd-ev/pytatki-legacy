...
SELECT a.iduser, a.login, b.idusergroup, b.name, b.color, b.description, b.image_path, b.parent_id FROM user a, usergroup b, user_membership c WHERE a.id_user = c.user_id AND b.idusergroup = c.usergroup_id;
