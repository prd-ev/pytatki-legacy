...
-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`usergroup_membership`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`usergroup_membership` (`id_user` INT, `login` INT, `idusergroup` INT, `name` INT, `color` INT, `description` INT, `image_path` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`note_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`note_view` (`idnote` INT, `value` INT, `title` INT, `'note_type'` INT, `'creator_id'` INT, `'creator_login'` INT, `usergroup_id` INT, `'usergroup_name'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`action_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`action_view` (`idaction` INT, `content` INT, `user_id` INT, `'login_user'` INT, `note_id` INT, `title` INT, `date` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`user_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`user_view` (`iduser` INT, `login` INT, `password` INT, `email` INT, `email_confirm` INT, `status_id` INT, `'status_name'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`note_tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`note_tags` (`idnote` INT, `tag_id` INT, `'tag_name'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`note_tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`note_tags` (`idnote` INT);

-- -----------------------------------------------------
-- View `mydb`.`usergroup_membership`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`usergroup_membership`;
USE `mydb`;
...
-- View `mydb`.`note_view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`note_view`;
USE `mydb`;
...
-- -----------------------------------------------------
-- View `mydb`.`action_view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`action_view`;
USE `mydb`;
...
-- View `mydb`.`user_view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`user_view`;
USE `mydb`;
...
-- View `mydb`.`note_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`note_tags`;
USE `mydb`;
