...
const AddNote = (props) => {
  ...
  let uploadNote = (e) => {
    ...
    formData.append('notegroup_id', props.that.state.currentDirId[props.that.state.currentDepth]);
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form id="form" className={ComponentStyle.form} onSubmit={uploadNote}>
