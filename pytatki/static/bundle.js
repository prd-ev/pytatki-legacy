...
var ReactDOMFeatureFlags = __webpack_require__(65);
var ReactElement = __webpack_require__(6);
var ReactEmptyComponentRegistry = __webpack_require__(72);
...
var _Notatki = __webpack_require__(90);

var _Notatki2 = _interopRequireDefault(_Notatki);
...
_reactDom2.default.render(_react2.default.createElement(_Notatki2.default, null), document.getElementById("reactEntry"));
...
var AddFolder = function (_Component) {
  _inherits(AddFolder, _Component);

  function AddFolder(props) {
    _classCallCheck(this, AddFolder);

    var _this = _possibleConstructorReturn(this, (AddFolder.__proto__ || Object.getPrototypeOf(AddFolder)).call(this, props));
  ...
  _createClass(AddFolder, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "form",
        { id: "addFolderForm", onSubmit: this.props.addFolder },
        _react2.default.createElement("input", { name: "title", type: "text" }),
        _react2.default.createElement("input", { type: "submit", value: "Dodaj folder w aktualnej lokalizacji" })
      );
    }
  }]);
...
var _AddNote = __webpack_require__(88);

var _AddNote2 = _interopRequireDefault(_AddNote);

var _AddFolder = __webpack_require__(87);

var _AddFolder2 = _interopRequireDefault(_AddFolder);

var _EditMode = __webpack_require__(89);

var _EditMode2 = _interopRequireDefault(_EditMode);

var _NotegroupList = __webpack_require__(91);

var _NotegroupList2 = _interopRequireDefault(_NotegroupList);
...
var Notatki = function (_React$Component) {
  ...
  function Notatki(props) {
    ...
    fetch(siteUrl + '/api?query={getToken}').then(function (response) {
      ...
      return fetch(siteUrl + '/api?query={getRootId(id_usergroup:1,access_token:"' + token + '")}').then(function (response) {
        return response.json();
  ...
  _createClass(Notatki, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_NotegroupList2.default, null),
        _react2.default.createElement(_AddNote2.default, { uploadNote: this.uploadNote }),
        _react2.default.createElement(_AddFolder2.default, { addFolder: this.addFolder }),
        _react2.default.createElement(_EditMode2.default, { changeMode: this.changeMode, isOn: this.state.editModeOn }),
        _react2.default.createElement(
          "h1",
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.changeCurrentDirectory = function (e) {
    ...
    fetch(siteUrl + '/api?query={getToken}').then(function (response) {
      ...
      try {
        for (var _iterator2 = innerJson[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var notegroup = _step2.value;
  ...
  this.prevFolder = function () {
    //Update current path and decrease depth (if 1 or higher)
    var path = _this2.state.currentPath;
    var depth = _this2.state.currentDepth;
    path.pop();
    if (!_this2.state.currentDepth < 1) {
      depth -= 1;
    }
    _this2.setState({
      currentDepth: depth,
  ...
  this.showCurrentPath = function () {
    ...
    try {
      for (var _iterator3 = _this2.state.currentPath[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  this.packContent = function () {
    //Show content of current depth form state (this.state.data)
    if (_this2.state.data[_this2.state.currentDepth]) {
      var content = [];
      ...
      try {
        for (var _iterator4 = _this2.state.data[_this2.state.currentDepth][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          if (value.is_note) {
            content.push(_react2.default.createElement(
              ...
              _react2.default.createElement(
                "h1",
                { onClick: _this2.openNote, id: value.key },
                "Notatka " + value.title
              ),
              _react2.default.createElement(
                "span",
                { onClick: _this2.deleteNote },
                _this2.state.editModeOn ? " x" : null
              )
            ));
          } else {
            content.push(_react2.default.createElement(
              ...
              _react2.default.createElement(
                "h1",
                { onClick: _this2.changeCurrentDirectory, id: value.key },
                value.title
              ),
              _react2.default.createElement(
                "span",
                { onClick: _this2.deleteFolder },
                _this2.state.editModeOn ? " x " : null
              )
            ));
          }
  ...
  this.uploadNote = function (e) {
    ...
    formData.append('notegroup_id', _this2.state.currentDirId[_this2.state.currentDepth]);
    fetch(siteUrl + '/add/', {
      method: 'POST',
      body: formData
    }).then(function (response) {
  ...
  this.addFolder = function (e) {
    ...
    formData.append('parent_id', _this2.state.currentDirId[_this2.state.currentDirId.length - 1]);
...
var NotegroupList = function (_Component) {
  _inherits(NotegroupList, _Component);

  function NotegroupList() {
    _classCallCheck(this, NotegroupList);

    return _possibleConstructorReturn(this, (NotegroupList.__proto__ || Object.getPrototypeOf(NotegroupList)).apply(this, arguments));
  }
